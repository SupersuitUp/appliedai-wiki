...
description: "The discipline of keeping documented truth aligned with operational reality. The full curriculum: principles, processes, and tools."
---

# Truth Management

*The discipline of keeping documented truth aligned with operational reality, so your systems can act on what is actually true. The full curriculum: principles, processes, and tools.*

---

For the conceptual frame and the case for why this discipline matters to an applied AI practitioner, start with the [Truth Management overview](/disciplines/truth-management). This sub-section is the operational depth: principles to internalize, processes to run, tools to install.
