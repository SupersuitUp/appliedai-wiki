...
## How to engage the sub-discipline

The full curriculum for truth management lives in [Truth Management (sub-section)](/disciplines/truth-management/). Start with:

- [Why It Matters](/disciplines/truth-management/why-it-matters): the three claims that build to the thesis.
- [Getting Started](/disciplines/truth-management/getting-started): the Day 1 to Week 4 sequenced rollout.
- [Don't Assume Common Sense](/disciplines/truth-management/dont-assume-common-sense): the foundational principle the rest of the discipline rests on.
