...
**You keep your optionality.** When your context is files on your machine and you work the harness directly, moving to a better tool is a config change, not a migration. A wrapper trades some of that portability for a friendlier surface. Cowork is a good wrapper. It is still a wrapper.
