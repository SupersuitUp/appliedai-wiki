...
This is the [You Are the Bottleneck](/perspectives/you-are-the-bottleneck) frame applied to agents. Smart hires cannot reach up and fix you from below. Smart agents cannot either. The judgment, architecture, and discrimination still have to come from you.
