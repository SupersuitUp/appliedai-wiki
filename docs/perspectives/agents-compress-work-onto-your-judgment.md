...
That is what [strategy is the new execution](/perspectives/strategy-is-the-new-execution) actually means in the body. Strategy is not a deck or a quarterly plan. Strategy is the daily question of: which problem deserves a judgment minute today? Which agent run is worth the supervision cost? Which output gets a careful review and which one gets a glance?
