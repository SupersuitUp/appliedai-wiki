...
- [Strategy Is the New Execution](/perspectives/strategy-is-the-new-execution) is the **frame**: the thing that makes prolific output valuable is the taste applied at each narrow, not the output itself.
