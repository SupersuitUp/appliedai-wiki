...
**You stay un-locked-in.** [The lock-in is coming](/perspectives/the-lock-in-is-coming). Every hyperscaler has the same incentive: pull you deeper into their platform until switching is unthinkable. Wrappers are the tip of that spear. Cowork is a good wrapper. It is still a wrapper.
...
- [The Lock-In Is Coming](/perspectives/the-lock-in-is-coming): Why every hyperscaler will eventually ship a wrapper
