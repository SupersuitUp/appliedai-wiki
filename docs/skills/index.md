...
| **start-agentic-project** | Stands a project up as a repo with a state machine, verbs and a supervising subagent, so closing the laptop costs nothing and reopening it costs one command. Interviews you for the ontology BEFORE scaffolding. See [Agentic Project Management](/concepts/agentic-project-management). | [Whole repo](https://github.com/SupersuitUp/agentic-project-template) · [`SKILL.md`](https://github.com/SupersuitUp/agentic-project-template/blob/master/SKILL.md) · [`template/`](https://github.com/SupersuitUp/agentic-project-template/blob/master/template/README.md) · [`BOOMERANG.md`](https://github.com/SupersuitUp/agentic-project-template/blob/master/BOOMERANG.md) (paste-in, for no Claude Code). Lives on GitHub, not here: it has tests, and one home beats two. |
