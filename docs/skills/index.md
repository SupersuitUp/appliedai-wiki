...
| **start-agentic-project** | Stands a project up as a repo with a state machine, verbs and a supervising subagent, so closing the laptop costs nothing and reopening it costs one command. Interviews you for the ontology BEFORE scaffolding. See [Agentic Project Management](/concepts/agentic-project-management). | [`SKILL.md`](https://www.appliedai.wiki/skills/start-agentic-project/SKILL.md) · [`template/`](https://www.appliedai.wiki/skills/start-agentic-project/template/README.md) · [`BOOMERANG.md`](https://www.appliedai.wiki/skills/start-agentic-project/BOOMERANG.md) (paste-in: interviews the person, returns a filled project) |
