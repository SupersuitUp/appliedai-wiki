...
slug: /concepts/judgment-burnout
...
- Running expensive reasoning models on tasks that do not need them.
...
This is the [token economy](/foundations/the-token-economy) failure mode at the personal level: thinking the goal is more tokens through the system, when the goal is the right tokens applied to the right problem.
...
- Use the [judgment line](/disciplines/the-judgment-line) discipline so deterministic work never touches your judgment layer in the first place.
...
- [Strategy Is the New Execution](/concepts/strategy-is-the-new-execution): The structural reason judgment is the new bottleneck.
- [The Judgment Line](/disciplines/the-judgment-line): The design rule that keeps deterministic work out of your judgment layer.
- [You Are the Bottleneck](/concepts/you-are-the-bottleneck): Adding agents and tools to a judgment-bottlenecked operator makes the bottleneck more expensive, not faster.
- [The Token Economy](/foundations/the-token-economy): The pricing layer that makes productivity theater feel cheap until it is not.
