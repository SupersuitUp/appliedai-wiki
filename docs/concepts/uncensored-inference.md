...
image: "/img/comics/uncensored-inference.webp"
---
...
- **Pros.** Cheapest path to "just works." No ops, instant access to permissive models, trivial to swap models when one disappoints. This is the [Model Upgrades Are No Longer Strictly Upgrades](/perspectives/model-upgrades-are-no-longer-strictly-upgrades) move: treat the model as a swappable dependency behind one interface.
