---
title: "Learn the Primitive, Not the Wrapper"
slug: /concepts/learn-the-primitive-not-the-wrapper
description: "Agentic harnesses like Claude Code, Hermes, and Codex are primitives. Vendor wrappers hide them to look friendlier. Learn the primitive so your skills transfer."
---

# Learn the Primitive, Not the Wrapper

*Agentic harnesses (Claude Code, Hermes, Codex) are primitives. Vendor wrappers over them (Claude Cowork, opinionated desktop apps) hide those primitives to look friendlier. Learn the primitives, so your skills transfer across every harness you will ever use.*

---

## The Question

In almost every onboarding session, someone asks some version of this:
...
## Why Learn the Harness Directly
...
**You stay un-locked-in.** Every hyperscaler has the same incentive: pull you deeper into their platform until switching is unthinkable. Wrappers are the tip of that spear. Cowork is a good wrapper. It is still a wrapper.
...
## Why Use VS Code (the File Viewer)

VS Code is not a harness. It is a file viewer that happens to be beloved by developers. That is all it needs to be.

Reasons to use it:

1. **You are going to have a lot of files.** Your agent workspace is a workspace full of markdown: your user profile, relationship dossiers, meeting transcripts, strategic documents, skills. You need something that makes browsing, opening, and editing many files fast.
...
4. **It makes your files first-class citizens.** The left sidebar is a living directory of your operational reality. Seeing your files at a glance trains the habit of trusting the system.
...
If you learn a vendor's wrapper, your skills die the day that wrapper changes. If you learn the harness and the files, your skills persist forever, because every future interface (including the one you or your team eventually builds) is just another wrapper over the same underlying thing.
...
What you are actually learning: **how to own your operational reality in a format that outlives any single vendor, any single harness, and any single wrapper.**
...
One step into the developer world. That is all the discipline is asking. You can go as deep as you want from there, or you can stop there and still be 10x ahead of people who only know a vendor wrapper.
