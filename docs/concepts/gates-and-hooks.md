...
![Three panels in the hyperagentic-age register, titled GATES AND HOOKS. One, THE RULE ON THE WALL: a woman in a mustard cardigan at a wooden desk points firmly at a blank sheet pinned to the wall while, inside the glowing amber laptop in front of her, two small agents ignore it, one carrying a box out through an open door. Two, THE GATE REFUSES: she sits back with her chin on her hands, calm, as the same agent inside the screen stops short of a heavy barred wooden door with the box still in its arms. Three, THE HOOK RUNS ANYWAY: she has walked away to the window with a mug, her back to the desk, and inside the screen a small brass bell rings on its own while one agent sweeps the floor with a broom and the other carries on working. Footer: INSTRUCTIONS ARE READ. GATES AND HOOKS ARE EXECUTED.](/img/comics/gates-and-hooks.webp)
