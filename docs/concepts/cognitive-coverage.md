...
image: "/img/comics/cognitive-coverage.webp"
---
...
- [Don't Move at Agentic Speed Without Extreme Test Coverage](/perspectives/dont-move-at-agentic-speed-without-extreme-test-coverage): the software-side instrument this concept is modeled on, and why the coverage bar moved when agents did the writing.
