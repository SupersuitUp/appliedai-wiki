...
slug: /playbooks/version-control-your-prompts
...
image: "/img/comics/version-control-your-prompts.webp"
---
...
This is the same logic as [The Harness Is the Thing Worth Learning](/perspectives/the-harness-is-the-thing-worth-learning) and [The Lock-In Is Coming](/perspectives/the-lock-in-is-coming). The prompt is the primitive. The model is the wrapper of the week. You want your work portable across the wrappers, anchored to artifacts you own.
...
- [The Harness Is the Thing Worth Learning](/perspectives/the-harness-is-the-thing-worth-learning): the prompt is the primitive
- [Software Is Disposable, Context Is the Asset](/perspectives/software-is-disposable-context-is-the-asset): the artifacts worth keeping outlive the tools that made them
