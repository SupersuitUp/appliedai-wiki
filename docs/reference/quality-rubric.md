...
- `grep -rniE 'AAS|Applied AI Society|Imagos|Curia Regis|Travis Oliphant|Pegasus|human unicorn|Daniel as a service|\bkings\b|Christofuturist|1000x' docs/` returns zero
