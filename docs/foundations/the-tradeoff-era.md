...
slug: /foundations/the-tradeoff-era
...
**Hold confident outputs to a higher bar.** GPT-5.5 confidently produces incorrect work more often than its predecessor. The output looks right. It is wrong more often. Verify before shipping. See [The Overconfidence Trap](/disciplines/the-overconfidence-trap) for the operator-side mirror of this same pattern.
...
- [LLM Psychosis](/disciplines/llm-psychosis)
