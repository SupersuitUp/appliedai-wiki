...
slug: /foundations/jevons-paradox
...
![Four-panel comic strip in bold neo-comic action-zine style on cream paper, crimson + cobalt + gold + arc-reactor cyan palette. Title bar: JEVONS PARADOX. Panel 1 1865: COAL: A Victorian-era industrial scene in inked silhouettes. A massive coal-fired steam engine billowing smoke. A small economist figure in coat-and-cravat (William Stanley Jevons) holding a leatherbound notebook. Speech bubble: 'MORE EFFICIENT. LESS COAL PER ENGINE. SO COAL DEMAND FALLS.' A bold red X scrawled over the word 'FALLS.' A bigger gold handwritten arrow next to it pointing UP labeled 'COAL DEMAND.' Caption: '1865. Steam engines got cheaper. Coal demand went up, not down.' Panel 2 THE 1980s: SPREADSHEETS: A pre-PC office bullpen with accountants in shirts-and-ties at wooden desks. One large CRT monitor glowing with a VisiCalc spreadsheet. A floating newspaper-style headline above: 'ACCOUNTANTS WILL BE OBSOLETE.' Bold red X over it. Below, a hiring chart with an arrow shooting upward labeled 'FINANCE PROFESSIONALS HIRED.' Caption: '1980s. Spreadsheets automated arithmetic. Finance hiring exploded.' Panel 3 2026: RADIOLOGY: A modern hospital reading room. A radiologist in scrubs reviewing a digital chest X-ray on a large screen. An AI overlay in cyan highlights subtle findings with small annotation tags. A floating headline: 'STOP TRAINING RADIOLOGISTS - HINTON 2016.' Bold red X over it. In gold lettering beside it: 'MORE RADIOLOGISTS TRAINED IN 2026 THAN EVER.' Small human figure icons multiplying. Caption: '2016 prediction: stop training radiologists. 2026 reality: more being trained than ever.' Panel 4 THE AI ERA: FIRST-PERSON POV through the supersuited leader's armored helmet visor. Translucent inked visor frame. Cyan HUD cards along the top: NEW CATEGORIES, LONG-TAIL SERVICES, HIGHER EXPECTATIONS, HIGH-CONTEXT ROLES. Below, a vast circular constellation of new work expanding outward: small icons of TUTORS, LAWYERS, COACHES, ANALYSTS, THERAPISTS, ENGINEERS, DESIGNERS, ADVISORS, CREATORS scattered across the view, connected by glowing lines. Side stats: VALUE CREATED rising, HUMAN JUDGMENT IRREPLACEABLE, POSSIBILITIES EXPANDING. Caption: 'AI does not shrink the workforce. It expands what is worth doing.' Footer bar: AUGMENT, DO NOT REPLACE. THE WINNERS GROW.](/img/comics/jevons-paradox.png)
...
3. **Critical thinking.** AI is often right. "Often" is not "always," and "right" is not always "what we wanted." The human in the loop has to notice the gap and correct it. [Strategy is the new execution.](/concepts/strategy-is-the-new-execution)
...
- Practice [spec writing](/disciplines/spec-writing) daily.
...
- [Strategy Is the New Execution](/concepts/strategy-is-the-new-execution): The skill that turns AI-era time savings into outputs worth expanding into.
